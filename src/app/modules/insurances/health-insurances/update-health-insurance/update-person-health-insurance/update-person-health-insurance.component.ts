...
export class UpdatePersonHealthInsuranceComponent {
  ...
  formGroup = new FormGroup({
    ...
    job_address: new FormControl(this.personHealthInsurance.job_address, Validators.required),
  ...
  updatePersonHealthInsurance(dialogRef: MatDialogRef<DialogComponent>) {
    ...
    this.personHealthInsurance.job_address = this.myForm.formGroup.get('job_address')?.value
